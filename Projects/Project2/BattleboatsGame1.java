        ...
        public static void main(String[] args){
            ...
            while (continueAsking){
                ...
                if (difficulty.equals("standard") || difficulty.equals("expert")){
                    ...
                    BattleboatsBoard1 randomBoard = new BattleboatsBoard1(difficulty);
                    ...
                    while (gameContinue){
                        ...
                        System.out.println("Choose an action by typing \"drone,\" \"missile,\" \"print,\" or \"fire.\": ");
                        move = askUser.next();
                        if (move.equals("missile")){
                            ...
                            moveCount = moveCount + randomBoard.fireResult(xPos, yPos); //adds penalty if needed
                            moveCount ++;
                            cannonShots ++;
